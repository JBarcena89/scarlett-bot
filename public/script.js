...
function mostrarMensaje(tipo) {
  let mensaje = '';
  if (tipo === 'contenido') {
    mensaje = 'Aquí tienes mi contenido VIP 😘 👉 <a href="https://fanlove.mx/scarlettWilson363" target="_blank">https://fanlove.mx/scarlettWilson363</a>';
  } else if (tipo === 'canal') {
    mensaje = 'Únete a mi canal de Telegram 💋 👉 <a href="https://t.me/+VYVI0yEKB5NkMTlh" target="_blank">https://t.me/+VYVI0yEKB5NkMTlh</a>';
  } else if (tipo === 'redes') {
    mensaje = 'Sígueme en todas mis redes 🌐 👉 <a href="https://www.atom.bio/scarlettwilson363" target="_blank">https://www.atom.bio/scarlettwilson363</a>';
  }
